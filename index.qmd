...
- [sätta meningsfulla personliga mål](1-0.qmd){sec-myths} (sidan \pageref{sec-myths}),
- [lära dig om konstruktiv självhävdelse](2-0.qmd) (sidan \pageref{sec-assertiveness}),
- [lära dig tänka mer flexibelt](3-0.qmd) (sidan \pageref{sec-thinking}),
- [bli varse vilket handlande som är ändamålsenligt](4-0.qmd) (sidan \pageref{sec-behaviour}) samt att
- [bli medveten om och hantera kroppsliga stressreaktioner](5-0.qmd) (sidan \pageref{sec-relaxation}).
