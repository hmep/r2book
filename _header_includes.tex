...
\sethead{\if 1\thexex\large\hwfamily\color{MidnightBlue}Exempel\else\fi}{}{\hbox{\includegraphics[width=13mm]{../sites/respekt/media/image/100respekt.pdf}}}
...
\newcommand\xfline[3]{\vbox to 0mm{#1}\foreach \n in {1,...,#2}{\fline{#3}}}
\newcommand\xhl[1]{#1 --}
