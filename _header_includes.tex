...
\usepackage{qrcode}
\newcommand\xqr[3]{\vspace{.5\baselineskip}\par\qrcode[height=2.5\baselineskip]{#1}\quad\parbox{.8\linewidth}{\small\href{#1}{#2\\\url{#1}}}\par}

\definecolor{quarto-callout-tip-color}{HTML}{00F9DE}
