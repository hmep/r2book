...
\newfontfamily{\hwfamily}{Tillana}[Path = ../resources/Tillana/,Extension = .ttf, UprightFont = *-Regular]
...
%\renewcommand{\subparagraph}[1]{\oldsubparagraph{#1}\mbox{}\par}
\usepackage{titlesec}
...
\sethead{}{}{\hbox{\includegraphics[width=13mm]{../sites/respekt/media/image/100respekt.pdf}}}
\setfoot{\rmfamily\small\thepage/\pageref*{LastPage}}{}{}
}
\newpagestyle{respektTurn}[\large\sffamily]{
\sethead{\if 1\thexex\begin{tikzpicture}[]\node[rotate=5] at (0,0) {\hwfamily\Large\color{MidnightBlue}Exempel};\end{tikzpicture}\else\fi}{}{\hbox{\includegraphics[width=13mm]{../sites/respekt/media/image/100respekt.pdf}}}
