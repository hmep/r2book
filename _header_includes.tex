...
\usepackage{qrcode}
\newcommand\xqr[3]{\centering\vspace{1.5\baselineskip}\hspace{3\baselineskip}\qrcode[height=3\baselineskip]{#1}\quad \parbox{.55\linewidth}{\small\href{#1}{#2\\\url{#1}}}\par\RaggedRight}