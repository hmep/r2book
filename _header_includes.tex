...
\usepackage{calc}
\usepackage{qrcode}
\newcommand\xqr[3]{\vspace{.5\baselineskip}\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{#2}{#1\\\url{#2}}}\vspace{.5\baselineskip}}
\newcommand\xqrform[3]{\vspace{.5\baselineskip}\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{https://100respekt.se/#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{https://100respekt.se/#2}{#1\\\url{https://100respekt.se/#2}}}\vspace{.5\baselineskip}}
