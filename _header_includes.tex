\newcommand\xpath{/home/tobias/Dokument/r2book}
...
\newfontfamily{\hwfamily}{Tillana}[Path = /home/tobiasadmin/r2book/resources/Tillana/,Extension = .ttf, UprightFont = *-Regular]
...
\usepackage{titlesec}
\titlespacing{\section}{0pt}{1.25\baselineskip}{.5\baselineskip}
\titlespacing{\subsection}{0pt}{0.75\baselineskip}{.25\baselineskip} %.5
\titlespacing{\subsubsection}{0pt}{0.75\baselineskip}{.25\baselineskip} %.25

\newpagestyle{respekt}[\large\sffamily]{
\sethead{}{}{\hbox{\includegraphics[width=13mm]{/home/tobiasadmin/r2book/sites/respekt/media/image/100respekt.pdf}}}
\setfoot{\rmfamily\small\thepage/\pageref*{LastPage}}{}{}
}

\newpagestyle{respektExample}[\large\sffamily]{
\sethead{\if 0\thexex\else\begin{tikzpicture}[]\node[rotate=5] at (0,0) {\hwfamily\Large\color{MidnightBlue}Exempel};\end{tikzpicture}\fi}{}{\hbox{\includegraphics[width=13mm]{/home/tobiasadmin/r2book/sites/respekt/media/image/100respekt.pdf}}}
\setfoot{\rmfamily\small\thepage/\pageref*{LastPage}}{}{}
}
...
\usepackage{calc}
\usepackage{qrcode}
\newcommand\xqr[3]{\vspace{.5\baselineskip}\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{#2}{#1\\\url{#2}}}\par\vspace{.5\baselineskip}}
\newcommand\xqrform[3]{\vspace{.5\baselineskip}\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{https://100respekt.se/#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{https://100respekt.se/#2}{#1\\\url{https://100respekt.se/#2}}}\par\vspace{.5\baselineskip}}
