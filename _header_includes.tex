...
\usepackage{calc}
\usepackage{qrcode}
\newcommand\xqr[3]{\vspace{.5\baselineskip}\par\hspace{0\baselineskip}\qrcode[height=2.5\baselineskip]{#1}\hspace{1\baselineskip}\parbox{1\linewidth-2.5\baselineskip}{\small\href{#1}{#2\\\url{#1}}}\par}
