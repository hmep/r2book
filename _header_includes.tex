...
\usepackage{calc}
\usepackage{qrcode}
\newcommand\xqr[3]{\vspace{.5\baselineskip}\par\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{#2}{#1\\\url{#2}}}\par}
\newcommand\xqrform[3]{\vspace{.5\baselineskip}\par\hspace{0\baselineskip}\qrcode[height=2.75\baselineskip]{#2}\hspace{.75\baselineskip}\parbox{1\linewidth-3.5\baselineskip}{\small\href{#2}{#1\\\url{https://100respekt.se/#2}}}\par}
