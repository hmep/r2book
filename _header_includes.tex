...
\sethead{\if 0\thexex\else\begin{tikzpicture}[]\node[rotate=5] at (0,0) {\hwfamily\Large\color{MidnightBlue}Exempel};\end{tikzpicture}\fi}{}{\hbox{\includegraphics[width=13mm]{../sites/respekt/media/image/100respekt.pdf}}}
\setfoot{\rmfamily\small\thepage/\pageref*{LastPage}}{}{}
}
